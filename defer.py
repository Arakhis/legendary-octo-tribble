...
def index_template():
    try:
        ...
        return render_template('index.html', script=js_lang())
...
def register_template():
    try:
        ...
        return render_template('register.html', newMnemonic=new_mnemonic(), script=js_lang())
...
def txs_template(page=1):
    ...
    try:
        ...
        return render_template("txs.html", script=js_lang(),
